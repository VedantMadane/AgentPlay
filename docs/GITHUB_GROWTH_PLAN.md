...
AgentPlay 已经不缺功能，也不缺 GitHub 基础设施。当前真正的瓶颈有三个：
...
- [ ] README、官网和所有下载按钮指向同一个当前推荐版本，明确“安装器 / 便携包如何选择”。
- [ ] Release 首屏从技术回执改为“谁适合测试、三分钟怎么成功、遇到问题去哪反馈”；哈希、SBOM 和扫描保留在后半部分。
...
3. [ ] 将Release / README主下载路径收敛到当前推荐Preview，并给出三分钟首次成功任务。PR45已合并；Preview4已安装公开，当前收尾分支统一入口，待合并与公开页面回读后勾选。
